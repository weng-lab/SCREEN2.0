...
export const figure = (num: number, alt: string, style = {}) => {
  const imgSrc = require("../../../public/assets/about/images/figure" + num + ".png")
  return (
    <div className={"panel panel-default"}>
      <div className="panel-body">
        <figure className={"figure"}>
          ...
          style={style}
          />
          {/* <img src={imgSrc} className={"figure-img img-fluid rounded img-responsive"} alt={alt} style={style} /> */}
