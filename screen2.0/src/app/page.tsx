    ...
    <main>
      <Grid container spacing={3} sx={{ mr: "auto", ml: "auto", mt: 5, maxWidth: "95%" }}>
        <Grid size={{ xs: 12, lg: 6 }}>
          ...
          <Typography>
            SCREEN is a web interface for searching and visualizing the Registry of candidate cis-Regulatory Elements
            (cCREs) derived from ENCODE data. The Registry contains 2,348,854 human cCREs in GRCh38 and 926,843 mouse
            cCREs in mm10, with homologous cCREs cross-referenced across species. SCREEN presents the data that support
            biochemical activities of the cCREs and the expression of nearby genes in specific cell and tissue types.
          </Typography>
          ...
          <Grid
            ...
            maxWidth={"500px"}
          >
            <Typography p={1} border={"1px solid LightGray"}>
              Genome Assembly
            </Typography>
            <Typography p={1} border={"1px solid LightGray"} align="right">
              cCRE Count
            </Typography>
            <Typography p={1} border={"1px solid LightGray"} align="right">
              Cell/Tissue Types
