    ...
    <Dialog open={open}>
      ...
      <DialogContent>
        {errorMsg?.includes("V2 cCRE redirection error :") ? (
          errorMsg.split("..")[2] === "" ? (
            <DialogContentText>
              This cCRE has been archived.
            </DialogContentText>
          ) : (
            <DialogContentText>
              This cCRE has been replaced by the following V4 cCRE(s):              
              <List dense>
                {errorMsg
                  .split("..")[2]
                  .split(",")
          ...
          <>
            <DialogContentText>Trying to parse:</DialogContentText>
            <DialogContentText>
            ...
            <Accordion>
              ...
              <AccordionDetails>{errorMsg}</AccordionDetails>
            </Accordion>
            <DialogContentText>
              If this is unexpected based on the info above, please feel free to{" "}
              <Link href="/about#contact-us">
                report it using our "Contact Us" form
              </Link>{" "}
              and provide us the error you're facing. Please copy the error
              before navigating! It will be lost.
            </DialogContentText>
          </>
        )}
      </DialogContent>
