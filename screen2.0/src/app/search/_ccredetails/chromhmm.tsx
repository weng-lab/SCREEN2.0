...
export const ChromHMM = (props: { coordinates , assembly, accession }) =>{
          ...
          fetch(config.ChromHMM.HumanChromHMM)
            ...
            .then((x) => {
                ...
                if(val[2])
                {
                    ...
                    {
                      let e = ch[val[2]]
                      e.push([val[0],val[3],`https://downloads.wenglab.org/ChIP_${val[1]}.bigBed`])
  
                        ch[val[2]] = e
  
                    } else {
                      ch[val[2]] = [[val[0],val[3],`https://downloads.wenglab.org/ChIP_${val[1]}.bigBed`]]
                    }
                }
    ...
    const chromhmmdata = data && !loading && data.bigRequests.map((b,i)=>{
        ...
        return {
            ...
            name:  stateDetails[f.name].description+' ('+ stateDetails[f.name].stateno+')',
            chr:  f.chr,
            color: f.color,
