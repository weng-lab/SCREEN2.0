...
export function getDefaultTracks(coordinates: { assembly: "GRCh38" | "mm10", chromosome: string, start: number, end: number }) {
    ...
    const defaultMouseTracks = [
        { ...DefaultBigBed, titleSize, id: randomID(), title: "All cCREs colored by group", displayMode: DisplayMode.DENSE, color: "#9378BC", rowHeight: 12, height: 50, url: "https://downloads.wenglab.org/mm10-cCREs.DCC.bigBed" } as BigBedTrackProps,
        { ...DefaultBigWig, titleSize, id: randomID(), title: "Aggregated DNase-seq signal, all Registry biosamples", color: "#06da93", height: 100, url: "gs://gcp.wenglab.org/dnase.mm10.sum.bigWig" } as BigWigTrackProps,

    ]

    const defaultHumanTracks = [
        { ...DefaultBigBed, titleSize, id: randomID(), title: "All cCREs colored by group", displayMode: DisplayMode.DENSE, color: "#9378BC", rowHeight: 12, height: 50, url: "https://downloads.wenglab.org/GRCh38-cCREs.DCC.bigBed" } as BigBedTrackProps,
