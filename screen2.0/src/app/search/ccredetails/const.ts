...
export const GenomeBrowserTooltip =
  "Use the handles at left to drag items and change the order in which they will display in the browser. \nNote: For the best UCSC performance, choose <10 cell types."
