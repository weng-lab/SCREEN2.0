...
const CCRETooltip = (props) => {
  const experiments = useMemo(
    () => (props.biosample ? ["dnase", "h3k4me3", "h3k27ac", "ctcf"] : ["dnase", "h3k4me3", "h3k27ac", "ctcf"]),
    [props]
  )
    ...
    <div style={{ border: "1px solid", padding: "0.75em", background: "#ffffff" }}>
      {loading || !data.cCREQuery[0] ? (
        ...
        <>
          ...
          <br />
          <br />
          <strong>{props.biosample ? "Z-scores in " + props.biosample : "Max Z-scores across all biosamples:"}</strong>
          <br />
