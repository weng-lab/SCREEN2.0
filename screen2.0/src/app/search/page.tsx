        ...
        >
          ...
          {page < numberOfDefaultTabs ?
            ...
            <Tabs
              ...
              {mainQueryParams.coordinates.assembly !== "mm10" && <StyledVerticalTab value={5} label="Associated Transcript Expression" />}
              {mainQueryParams.coordinates.assembly !== "mm10" && <StyledVerticalTab value={6} label="Transcription at cCRE" />}
              <StyledVerticalTab value={7} label="Functional Data" />
