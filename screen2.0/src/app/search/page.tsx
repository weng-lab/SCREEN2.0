        ...
        >
          ...
          {page < numberOfDefaultTabs ?
            ...
            <Tabs
              ...
              {mainQueryParams.coordinates.assembly !== "mm10" && <StyledVerticalTab value={6} label="Transcription at cCRE" sx={{ alignSelf: "start" }} />}
              ...
              <StyledVerticalTab value={10} label="Configure UCSC Genome Browser" sx={{ alignSelf: "start" }} />
              {mainQueryParams.coordinates.assembly !== "mm10" && <StyledVerticalTab value={11} label="ENTEx" sx={{ alignSelf: "start" }} />}
            </Tabs>
          }
        </Drawer>
