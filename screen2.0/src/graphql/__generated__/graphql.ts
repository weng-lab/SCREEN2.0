...
export type GeneLocationQueryVariables = Exact<{
  name: Scalars['String']['input'];
  assembly: Scalars['String']['input'];
...
export type GeneLocationQuery = { __typename?: 'Query', gene?: Array<{ __typename?: 'Gene', name: string, coordinates: { __typename?: 'GenomicRange', chromosome: string, start: number, end: number } } | null> | null };

export type Q_2QueryVariables = Exact<{
  accession: Scalars['String']['input'];
  assembly: Scalars['String']['input'];
}>;


export type Q_2Query = { __typename?: 'Query', getcCRETFQuery?: Array<{ __typename?: 'CelltypeTF', celltype: string, tf: string } | null> | null };

export type Q_3QueryVariables = Exact<{
  accession?: InputMaybe<Array<Scalars['String']['input']> | Scalars['String']['input']>;
  assembly: Scalars['String']['input'];
}>;


export type Q_3Query = { __typename?: 'Query', ccREBiosampleQuery: { __typename?: 'RegistryBiosampleCollection', biosamples?: Array<{ __typename?: 'RegistryBiosample', sampleType: string, displayname: string, name: string, ontology: string, cCREZScores: Array<{ __typename?: 'CCREZScore', score: number, assay: string, experiment_accession: string }> }> | null }, cCREQuery: Array<{ __typename?: 'CCRE', accession: string, group: string, dnase?: number | null, h3k4me3?: number | null, h3k27ac?: number | null, ctcf?: number | null, atac?: number | null }> };

export type Features_1QueryVariables = Exact<{
...
export type Features_1Query = { __typename?: 'Query', gene?: Array<{ __typename?: 'Gene', name: string, id: string, strand: string, coordinates: { __typename?: 'GenomicRange', chromosome: string, start: number, end: number }, transcripts?: Array<{ __typename?: 'Transcript', id: string, coordinates: { __typename?: 'GenomicRange', chromosome: string, start: number, end: number } } | null> | null } | null> | null, cCREQuery: Array<{ __typename?: 'CCRE', accession: string, group: string, coordinates: { __typename?: 'GenomicRange', chromosome: string, start: number, end: number } }>, snpQuery: Array<{ __typename?: 'SNP', id: string, coordinates: { __typename?: 'GenomicRange', chromosome: string, start: number, end: number } }> };

export type Features_2QueryVariables = Exact<{
  coordinates?: InputMaybe<Array<GenomicRangeInput> | GenomicRangeInput>;
  chromosome?: InputMaybe<Scalars['String']['input']>;
  start?: InputMaybe<Scalars['Int']['input']>;
  end?: InputMaybe<Scalars['Int']['input']>;
...
export type Features_2Query = { __typename?: 'Query', gene?: Array<{ __typename?: 'Gene', name: string, id: string, strand: string, coordinates: { __typename?: 'GenomicRange', chromosome: string, start: number, end: number }, transcripts?: Array<{ __typename?: 'Transcript', id: string, coordinates: { __typename?: 'GenomicRange', chromosome: string, start: number, end: number } } | null> | null } | null> | null, cCREQuery: Array<{ __typename?: 'CCRE', accession: string, group: string, coordinates: { __typename?: 'GenomicRange', chromosome: string, start: number, end: number } }> };
